...
colorizer_resnet50 = resnet50_colorizer(pretrained=False).eval()
if(opt.use_gpu):
	colorizer_eccv16.cuda()
	colorizer_siggraph17.cuda()
	colorizer_resnet50.cude()
...
out_img_resnet50 = postprocess_tens(tens_l_orig, colorizer_resnet50(tens_l_rs).cpu())
